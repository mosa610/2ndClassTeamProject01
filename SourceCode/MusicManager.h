...
public:
	MusicManager()
	{
		...
		music::load(BGM::TITLE, L"./Data/Sounds/Title/Ozone_AdobeStock_356955431_preview.wav", 0.3f);
		music::load(BGM::GAME, L"./Data/Sounds/Music/Free-Power-(Rock)_AdobeStock_680539019_preview.wav", 0.2f);
